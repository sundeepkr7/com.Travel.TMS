...
public class ExcelToDatabase {
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		String sql="create table place1 (LOCATION_ID decimal(4,0), STREET_ADDRESS varchar(40),POSTAL_CODE varchar(12),CITY varchar(30),STATE_PROVINCE varchar(25),COUNTRY_ID varchar(2))";
		stmt.execute(sql);
		
		//Excel
		FileInputStream fis=new FileInputStream(".\\src\\test\\resources\\locations.xlsx");
		...
		for(int r=1;r<=rows;r++)
		{
			...
			sql="insert into place1 values('"+locId+"', '"+streatAdd+"', '"+postalCode+"', '"+city+"', '"+stateProv+"', '"+countryId+"')";
			stmt.execute(sql);
			stmt.execute("commit");
		}
